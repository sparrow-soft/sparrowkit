...
# Real Rails encrypted Development credentials for the panel's request specs,
# built fresh per example in an ignored directory.
#
...
module ConsoleCredentials
  ...
  def stored
    stored_tree[SparrowMail::CREDENTIALS_KEY] || {}
  end
